...
arm-none-eabi-g++ -Wno-write-strings -nostartfiles -specs=nosys.specs -mfloat-abi=hard -mfpu=vfp -O0 -march=armv6zk -mtune=arm1176jzf-s -o %BUILD%kernel.elf %FILES%
